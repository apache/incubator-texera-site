...
aliases:
  - /docs/reference/operators/machine-learning/sklearn/
...
| [Bernoulli Naive Bayes](bernoulli-naive-bayes/) | Sklearn Bernoulli Naive Bayes Operator |
| [Complement Naive Bayes](complement-naive-bayes/) | Sklearn Complement Naive Bayes Operator |
...
| [Logistic Regression Cross Validation](logistic-regression-cross-validation/) | Sklearn Logistic Regression Cross Validation Operator |
| [Multi-layer Perceptron](multi-layer-perceptron/) | Sklearn Multi-layer Perceptron Operator |
