...
<tbody>
<tr>
<td style="padding: 16px 18px; background: #fbf7ef; border-bottom: 1px solid #e3dccd; font-family: 'Helvetica Neue',Arial,sans-serif; font-size: 15.5px; vertical-align: top;"><b>1. The property panel decides what is exposable.</b> The tick box and the exposability rules live with the operator schema, so the form never has its own opinion about which properties can become fields.
<a style="text-decoration: none;" href="https://github.com/apache/texera/pull/8318" target="_blank" rel="noopener"><span style="font-size: 12.5px; font-weight: bold; color: #c8451f; background: rgba(200,69,31,.10); padding: 1px 7px; border-radius: 5px; white-space: nowrap; margin-left: 6px;">PR #8318</span></a><a style="text-decoration: none;" href="https://github.com/apache/texera/pull/8436" target="_blank" rel="noopener"><span style="font-size: 12.5px; font-weight: bold; color: #c8451f; background: rgba(200,69,31,.10); padding: 1px 7px; border-radius: 5px; white-space: nowrap; margin-left: 6px;">PR #8436</span></a></td>
</tr>
<tr>
<td style="padding: 16px 18px; background: #fbf7ef; border-bottom: 1px solid #e3dccd; font-family: 'Helvetica Neue',Arial,sans-serif; font-size: 15.5px; vertical-align: top;"><b>2. Fields render and write back through formly.</b> An exposed binding becomes a formly field; editing it writes to the operator property, including nested objects and repeated arrays.
<a style="text-decoration: none;" href="https://github.com/apache/texera/pull/8437" target="_blank" rel="noopener"><span style="font-size: 12.5px; font-weight: bold; color: #c8451f; background: rgba(200,69,31,.10); padding: 1px 7px; border-radius: 5px; white-space: nowrap; margin-left: 6px;">PR #8437</span></a><a style="text-decoration: none;" href="https://github.com/apache/texera/pull/8438" target="_blank" rel="noopener"><span style="font-size: 12.5px; font-weight: bold; color: #c8451f; background: rgba(200,69,31,.10); padding: 1px 7px; border-radius: 5px; white-space: nowrap; margin-left: 6px;">PR #8438</span></a></td>
</tr>
<tr>
<td style="padding: 16px 18px; background: #fbf7ef; border-bottom: 1px solid #e3dccd; font-family: 'Helvetica Neue',Arial,sans-serif; font-size: 15.5px; vertical-align: top;"><b>3. Running is the canvas's state machine.</b> The run button, the computing-unit selector and the error reporting are the canvas's, not a copy, so a state the canvas can reach is a state the form can reach.
<a style="text-decoration: none;" href="https://github.com/apache/texera/pull/8440" target="_blank" rel="noopener"><span style="font-size: 12.5px; font-weight: bold; color: #c8451f; background: rgba(200,69,31,.10); padding: 1px 7px; border-radius: 5px; white-space: nowrap; margin-left: 6px;">PR #8440</span></a></td>
</tr>
<tr>
<td style="padding: 16px 18px; background: #fbf7ef; border-bottom: 1px solid #e3dccd; font-family: 'Helvetica Neue',Arial,sans-serif; font-size: 15.5px; vertical-align: top;"><b>4. Edit mode authors the form in place.</b> Rename, help text, reorder, remove, the Markdown instruction and the result choice, all written into <code>formBinding</code>.
<a style="text-decoration: none;" href="https://github.com/apache/texera/pull/8516" target="_blank" rel="noopener"><span style="font-size: 12.5px; font-weight: bold; color: #c8451f; background: rgba(200,69,31,.10); padding: 1px 7px; border-radius: 5px; white-space: nowrap; margin-left: 6px;">PR #8516</span></a><a style="text-decoration: none;" href="https://github.com/apache/texera/pull/8517" target="_blank" rel="noopener"><span style="font-size: 12.5px; font-weight: bold; color: #c8451f; background: rgba(200,69,31,.10); padding: 1px 7px; border-radius: 5px; white-space: nowrap; margin-left: 6px;">PR #8517</span></a></td>
</tr>
<tr>
<td style="padding: 16px 18px; background: #fbf7ef; font-family: 'Helvetica Neue',Arial,sans-serif; font-size: 15.5px; vertical-align: top;"><b>5. Entry points and the default view.</b> The dashboard, the route and the switch in the canvas menu, plus remembering the computing unit a workflow last ran on.
<a style="text-decoration: none;" href="https://github.com/apache/texera/pull/8456" target="_blank" rel="noopener"><span style="font-size: 12.5px; font-weight: bold; color: #c8451f; background: rgba(200,69,31,.10); padding: 1px 7px; border-radius: 5px; white-space: nowrap; margin-left: 6px;">PR #8456</span></a></td>
</tr>
</tbody>
</table>
