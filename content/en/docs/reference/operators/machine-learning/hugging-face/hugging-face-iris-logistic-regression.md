...
|----------|-------------|------|---------|-------------|
| Petal Length Cm Attribute | ✓ | Column | - | Attribute in your dataset corresponding to<br>PetalLengthCm |
| Petal Width Cm Attribute | ✓ | Column | - | Attribute in your dataset corresponding to<br>PetalWidthCm |
